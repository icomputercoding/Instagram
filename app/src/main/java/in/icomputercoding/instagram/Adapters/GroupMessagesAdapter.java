...
import in.icomputercoding.instagram.databinding.DeleteDialogBinding;
import in.icomputercoding.instagram.databinding.ItemReceiveGroupBinding;
import in.icomputercoding.instagram.databinding.ItemSentGroupBinding;
...
public class GroupMessagesAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder.getClass() == SentViewHolder.class) {
            ...
            viewHolder.binding.message.setOnTouchListener((View.OnTouchListener) (v, event) -> {
                popup.onTouch(v, event);
                return false;
            });

            viewHolder.binding.image.setOnTouchListener((View.OnTouchListener) (v, event) -> {
                popup.onTouch(v, event);
                return false;
            });
            ...
            viewHolder.itemView.setOnLongClickListener(v -> {
                ...
                binding.everyone.setOnClickListener((View.OnClickListener) v13 -> {
                ...
                binding.cancel.setOnClickListener((View.OnClickListener) v1 -> dialog.dismiss());
